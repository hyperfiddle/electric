...
(defn cannot-resolve [& args]
  (apply println "[!_!] definition called on a peer that doesn't support it" args)
  #_(throw (ex-info "definition called on a peer that doesn't support it" {:args args})))
