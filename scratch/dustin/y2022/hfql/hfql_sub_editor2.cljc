(ns dustin.y2022.hfql.hfql-sub-editor2
  (:require [clojure.spec.alpha :as s]
            [hyperfiddle.api :as hf]
            [hyperfiddle.photon :as p]
            [hyperfiddle.photon-dom :as dom]
            [hyperfiddle.photon-ui2 :as ui])
  #?(:cljs (:require-macros dustin.y2022.hfql.hfql-sub-editor2)))
...
(p/defn []
  (hf/hfql
    {identity ; pass through, but why?
     {:query nil
      :tx (school-requested-block ; specs, must have
            sub
