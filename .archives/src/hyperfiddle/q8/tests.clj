(ns hyperfiddle.q8.tests
  (:require [clojure.spec.alpha :as s]
            [hfdl.lang :as p]
            [hyperfiddle.api :as hf]
            [hyperfiddle.q8 :refer [hfql]]
            [hyperfiddle.q8.impl :refer [dependencies parse reverse-deps references toposort]]
...
(def test-form '[{(hyperfiddle.q8/submissions "") [:user/email
                                                   {(:user/gender . ::hf/options hyperfiddle.q8/genders) [(:db/ident . ::hf/as gender)]}
                                                   {(:user/shirt-size . ::hf/options #'(shirt-sizes gender)) [:db/ident]}]}
                 {(hyperfiddle.q8/genders) [:db/ident]}])
...
(tests (dependencies (parse test-form))
       := '{gender                                                      #{},
            ...
            traverse__hyperfiddle.q8_submissions_-882945936->-413203446 #{collect__-413203446},
            ...
            traverse__hyperfiddle.q8_genders_1712563381->2075314760     #{collect__2075314760},
            ...
            collect__340489282                                          #{traverse__hyperfiddle.q8_submissions_-882945936->-413203446
                                                                          traverse__hyperfiddle.q8_genders_1712563381->2075314760}})

(tests
 (toposort (dependencies (parse test-form))) := '{gender                                                      0,
                                                  nav__db_ident_1311322104                                    0,
                                                  traverse__hyperfiddle.q8_submissions_-882945936->-413203446 4,
                                                  collect__-413203446                                         3,
                                                  nav__user_email_-1193137536                                 0,
                                                  traverse__hyperfiddle.q8_genders_1712563381->2075314760     2,
