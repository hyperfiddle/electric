...
;; Inject handlers into Electric
;; This is a temporary solution. Two cons:
;; - it exposes an implementation namespace,
;; - it mutates a global var.
;; In the future, serialization strategy should be scoped to a program and injectable at the app entrypoint.
